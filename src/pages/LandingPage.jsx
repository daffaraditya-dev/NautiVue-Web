            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.map(({ icon: Icon, title, description }) => (
                <motion.div
                  key={title}
                  variants={fadeUp}
                  className="bg-ocean-800/50 border border-ocean-700/50 rounded-2xl p-8 hover:border-teal-500/30 transition-colors duration-300"
                >
      ...
      <section className="w-full py-20">
        <div className="w-full max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-linear-to-br from-ocean-700 via-ocean-800 to-ocean-900 border border-ocean-600/30 p-16 text-center"
          >
